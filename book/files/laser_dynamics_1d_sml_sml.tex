...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \section{Laser Oscillators: One-Dimensional Single-Mode Dynamical Models\label{sct:laser_dynamics_1d_sml_sml}}
...
\begin{subequations} \label{eqn:la1d_sml_dynamics}
  ...
  \end{align}
\end{subequations}
where $H_0(t) \equiv G_0(t) / G_\mathrm{th}$ is the dimensionless scaled pump. Regardless of the specific form of $\Lo$, note that
\begin{equation}
  \label{eqn:ld1d_sml_pulling}
  1 + i\, \frac{\imls}{\rels} = \frac{2\, \Lo}{\Lo + \mathcal{L}^\ast(\Omega)} \, . 
\end{equation}
Implicit in \eqn{la1d_sml_dynamics} is the spatial dependence of the lowest-order eigenmodes developed in \chp{laser_resonators_1d} and used extensively in \chp{laser_statics_1d} to describe single-mode continuous-wave lasers.
