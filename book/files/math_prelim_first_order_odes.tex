...
In \chp{laser_dynamics_1d_sml} and \chp{laser_dynamics_1d_mml}, we will rely on the formal solutions of \eqn{cw_sml_ftz_scaled} and \eqn{cw_sml_gtz_scaled} (as well as their inhomogeneous counterparts), in both integral and differential Taylor-series forms. For example, consider the ordinary differential equation
