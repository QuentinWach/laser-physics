...
\end{equation}
should give $\dot{\phi}_q(t) \approx 0$ when $\dot{A}_q(t) = 0$. If $\omega_0 = \omega_{a b}$, then
\begin{equation} \label{eqn:mml_1d_omega_q_def}
    \Omega_q \longrightarrow \Omega_q + \delta \omega_q\, \tau_\perp\, ,
\end{equation}
where $\Omega_q = 2\, q\, \pi\, \tau_\perp$, and we can solve for $\delta \omega_q$ to obtain
...
\begin{equation} \label{eqn:mml_1d_omega_q_general}
